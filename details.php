               ...
               <div id="productMain" class="row"><!-- row Begin -->
                   ...
                   <div class="col-sm-6"><!-- col-sm-6 Begin -->
                       <div class="box"><!-- box Begin -->
                           ...
                           <form action="details.php?ertek=<?php echo $product_id; ?>" class="form-horizontal" method="post"><!-- form-horizontal Begin -->
                               <div class="form-group"><!-- form-group Begin -->
                                   <label for="" class="col-md-5 control-label">Mennyiség</label>
                                   
                                   <div class="col-md-7"><!-- col-md-7 Begin -->
                                        <input type="text" name="product_qty" id="" class="form-control" required>
